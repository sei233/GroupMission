...
<head>
    ...
    <script type="text/javascript" src="{pageContext.request.contextPath }/web/js/page.js"></script>
    <link rel="stylesheet" href="{pageContext.request.contextPath }/web/css/page.css">
