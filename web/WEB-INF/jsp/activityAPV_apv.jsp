...
<br>
<div class="container">
    <form action="${pageContext.request.contextPath}/activityAPV_out?type=yes" method="post" class="form-inline">
        ...
        <div class="form-group">
            <span>开始时间</span>
            <input type="text" value="${activity.beginTime}" readonly="readonly">
        </div>
        <br>
        <br>
        <div class="form-group">
            <span>结束时间</span>
            <input type="text" value="${activity.endTime}" readonly="readonly">
        </div>
        <br>
        <br>
        <div class="form-group">
        ...
        <div class="form-group">
            <span>审批状态</span>
            <input type="text" name="approveState" class="form-control" value="${activity.approveState}" readonly="readonly">
        </div>
        <br>
        <br>
        <div class="form-group">
            <span>审批评语</span>
            <input type="text" name="approveComment" class="form-control" value="${activity.approveComment}">
        </div>
        <br>
        <br>
        <div class="form-group">
            <input class="btn btn-warning" type="submit" value="审核通过">
            <%--<a class="btn btn-primary box_relative" href="${pageContext.request.contextPath }/activityAPV_out?type=ok">审核通过</a>--%>
            <a class="btn btn-warning box_relative" href="${pageContext.request.contextPath }/activityAPV_out?type=no&id=${activity.activityId}">审核不通过</a>
