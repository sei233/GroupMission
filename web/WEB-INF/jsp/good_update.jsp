...
<body>
<div class="container">
    <form action="/good_out?type=updateThis" method="post" class="form-inline">
        <div>
            <div class="form-group">
                <span>编号&nbsp;</span><input type="text" name="goodId" class="form-control" value="${good.goodId}" readonly="readonly">
            </div>
            <br>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
                <span>商品名称&nbsp;</span>
                <input  name="goodName" class="form-control" value="${good.goodName}">
            </div>
            <br>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
                <span>市场价&nbsp;</span>
                <input  name="goodMarketPrice" class="form-control" value="${good.goodMarketPrice}">
            </div>
            <br>
            <br>
            <div class="form-group">
                <span>商城价&nbsp;</span>
                <input  name="goodShopPrice" class="form-control" value="${good.goodShopPrice}">
            </div>
            <br>
            <br>
            <div class="form-group">
                <span>库存&nbsp;</span>
                <input  name="goodNumber" class="form-control" value="${good.goodNumber}">
            </div>
            <br>
            <br>
            <div class="form-group">
                <span>操作人&nbsp;</span>
                <input  name="operator" class="form-control" value="${good.operator}">
            </div>
            <br>
            <br>
            <div class="form-group">
